                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8 items-start">
                        ...
                        <div class="flex flex-col justify-center">
                             <div class="flex lg:justify-start justify-center">
                                <svg
                                    class="h-12 w-auto text-black dark:text-white lg:h-16"
                                    viewBox="0 0 62 65"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                                     <!-- Logo Path (Truncated for brevity, reusing existing logo) -->
                                    <path
                            ...
                            <h1 class="text-3xl font-bold mt-4 text-black dark:text-white">Welcome to Laravel</h1>
                            <p class="mt-4 text-gray-600 dark:text-gray-400">
                                A comprehensive framework for web artisans.
                            </p>
                        </div>

                        <!-- Auth Form Section -->
                        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-8 w-full">
                            <div class="flex justify-center mb-6 border-b border-gray-200 dark:border-gray-700">
                                <button
                                    @click="isLogin = true"
                                    :class="{'border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400': isLogin, 'text-gray-500 dark:text-gray-400': !isLogin}"
                                    class="px-4 py-2 font-semibold transition-colors duration-200 focus:outline-none"
                                >
                                    Log in
                                </button>
                                <button
