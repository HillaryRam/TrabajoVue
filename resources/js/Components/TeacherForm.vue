      ...
      <div class="card w-full max-w-2xl bg-base-100 shadow-xl">
        <div class="card-body">
          <h2 class="card-title text-2xl font-bold">
            {{ props.teacher ? "Editar Profesor" : "Nuevo Profesor" }}
          </h2>
          ...
          <form @submit.prevent="submit" class="space-y-4">
            ...
            <!-- Password (Solo si es nuevo o si se quiere cambiar) -->
            <template v-if="!props.teacher">
                <div class="form-control">
                <label class="label">
            ...
            <div class="card-actions justify-end mt-6">
              ...
              >
                {{ props.teacher ? "Actualizar" : "Crear Profesor" }}
              </button>
            </div>
